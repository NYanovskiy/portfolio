    ...
    <form class="filter__form form" action="#" method="get" @submit.prevent="submit">
      ...
      <fieldset class="form__block">
        ...
        <label class="form__label form__label--select">
          <select class="form__select" type="text" name="category" v-model.number="currentCategorieId">
...
export default {
  ...
  methods: {
    submit(){
      ...
      this.$emit('update:category', this.currentCategorieId);
