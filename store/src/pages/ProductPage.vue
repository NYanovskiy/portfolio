    ...
    <section class="item">
      <div class="item__pics pics">
        <div class="pics__wrapper">
          <img width="570" height="570" :src="peoduct.image"
            :alt="peoduct.title">
        </div>
        <!-- <ul class="pics__list">
          <li class="pics__item">
      ...
      <div class="item__info">
        <span class="item__code">Артикул: {{ peoduct.id }}</span>
...
export default {
  ...
  computed: {
    ...
    category() {
      return categories.find(category => category.id === this.peoduct.categoryId)
    }
  },
  methods: {
    gotoPage
